...
public class MyBoolToObjectConverter : MyBoolToObjectConverterExt<object>
{
}
/// <summary>
/// Converts <see cref="bool"/> to object and vice versa.
/// </summary>
public class MyBoolToObjectConverterExt<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] TObject> : BaseConverter<bool, TObject?>
{
    /// <inheritdoc/>
